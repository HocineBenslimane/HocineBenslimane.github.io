    ...
    <div>
      ...
      <div id="courses" class="courses-section my-24 text-center">
        ...
        <div class="mt-6 max-w-xl mx-auto">
          ...
          <p class="text-sm md:text-md">I often get requests to create custom content sush as individual courses, one-off videos, articles, etc. If you're interested in something,contact me and include all of the necessary details.</p>
          <g-link
            class="btn mr-auto mt-8 font-bold py-3 px-8 rounded-sm text-sm inline-block uppercase"
            v-scroll-to="'#contact'"
            data-cursor-hover
